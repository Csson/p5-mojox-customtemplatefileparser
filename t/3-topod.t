...
my $parser = MojoX::CustomTemplateFileParser->new(path => 'corpus/test-1.mojo', plugins => ['ToPod']);
...
my $expected_test_1_2_first_first = qq{     <input name="username" placeholder="first" type="text" /> };
...
my $expected_test_1_2_name_name = qq{     <input name="username" placeholder="name" type="text" /> };
...
is $parser->to_pod(1), $expected, 'Creates correct pod' || warn $parser->to_pod(1);
